...
class ReasoningLayer(nn.Module):
    ...
    def __init__(self, emb_size=255, num_heads=8, depth=1,
                 expansion_rate=1, dropout_rate=0.1):
    ...
    def forward(self, src):
        # get the spatial dimension in case of different sized input
        spatial_d1 = src.shape[2]
        spatial_d2 = src.shape[3]
