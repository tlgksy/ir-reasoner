...
if __name__ == '__main__':
    main_path = "/truba/home/taksoy/workspace/yolor-reasoner"
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='', help='initial weights path')
    # parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--cfg', type=str, default=main_path+'/cfg/yolor_p6_reasoner.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default=main_path+'/data/coco.yaml', help='data.yaml path')
    # parser.add_argument('--hyp', type=str, default=main_path+'/data/hyp.scratch.1280.yaml', help='hyperparameters path')
    parser.add_argument('--hyp', type=str, default=main_path + '/data/hyp.finetune.1280.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default=main_path+'/runs/train', help='save to project/name')
    parser.add_argument('--name', default='exp', help='save to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    opt = parser.parse_args()

    opt.resume = main_path+'/runs/train/exp3/weights/last.pt'
